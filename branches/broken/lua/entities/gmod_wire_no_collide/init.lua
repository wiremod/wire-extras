	...
	if (iname == "Activate") then
		...
		if ( value == 0 ) then
			...
			for i in pairs(self.EntInfo) do
	            ...
	            //entInfo.Ent:SetColor( Color(entInfo.OffColor[1], entInfo.OffColor[2], entInfo.OffColor[3], entInfo.OffColor[4]) )
		...
		if ( value > 0 ) then
			...
			for i in pairs(self.EntInfo) do
	            ...
	            //entInfo.Ent:SetColor( Color(entInfo.OnColor[1], entInfo.OnColor[2], entInfo.OnColor[3], entInfo.OnColor[4]) )
