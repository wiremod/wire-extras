...
E2Helper.Descriptions["dumpItem(xsc:nn)"] = "Dumps state control by number identifier in the specified area by first argument"
E2Helper.Descriptions["dumpItem(xsc:ns)"] = "Dumps state control by string identifier in the specified area by first argument"
...
E2Helper.Descriptions["maxStControls()"] = "Returns the upper state control count"
...
E2Helper.Descriptions["sumStControls()"] = "Returns the used state control count"
